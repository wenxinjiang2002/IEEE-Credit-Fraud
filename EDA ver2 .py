...
* Missing Value
    ...
    - Filling median for numerical columns
    - Filling most frequent value for categorical columns
* # Columns（Encoding 后）： 2278
* Imbalance:
...
Key difference from the former data processing
- Train/Test Split
    * Time-Based Split: Maintains temporal order but may not preserve stratification.
    * Stratified Split with Temporal Awareness: Balances fraud proportions but could slightly break temporal continuity.
- SMOTE oversampling
---------------------------------------------------------
